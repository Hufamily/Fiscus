...
S3 upload handling + Lambda extraction pipeline. See GitHub issues A2, A3,
A4 (`gh issue list`) and the data model in [`AGENTS.md` §4](../../AGENTS.md).
...
Read [the Free Tier cost guard](./aws-pipeline-A2/COST-GUARD.md) before
deploying. It makes Bedrock opt-in because model inference is metered.
