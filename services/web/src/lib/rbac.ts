...
const MATRIX: Record<Role, Capability[]> = {
  ...
  reviewer: ["review_extractions", "apply_corrections", "approve_templates", "view_row_level_transactions"],
  treasurer: ["review_extractions", "approve_templates", "view_row_level_transactions", "view_aggregate_reports"],
